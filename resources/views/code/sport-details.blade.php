...
@endphp
        ...
        <div class="card card-style">
            ...
            <div class="content">
                ...
                <p class="opacity-80">
                    <i class="fa icon-30 text-center far fa-clock pe-2"></i>@if ($today == $center->open_monday) Today is open From {{date("g:i a", strtotime($center->time_from_monday))}} To {{date("g:i a", strtotime($center->time_to_monday))}} @elseif ($today == $center->open_tuesday) Today is open From {{date("g:i a", strtotime($center->time_from_tuesday))}} To {{date("g:i a", strtotime($center->time_to_tuesday))}} @elseif ($today == $center->open_wednesday) Today is open From {{date("g:i a", strtotime($center->time_from_wednesday))}} To {{date("g:i a", strtotime($center->time_to_wednesday))}} @elseif ($today == $center->open_thursday) Today is open From {{date("g:i a", strtotime($center->time_from_thursday))}} To {{date("g:i a", strtotime($center->time_to_thursday))}} @elseif ($today == $center->open_friday) Today is open From {{date("g:i a", strtotime($center->time_from_friday))}} To {{date("g:i a", strtotime($center->time_to_friday))}} @elseif ($today == $center->open_saturday) Today is open From {{date("g:i a", strtotime($center->time_from_saturday))}} To {{date("g:i a", strtotime($center->time_to_saturday))}} @elseif ($today == $center->open_sunday)Today is open From {{date("g:i a", strtotime($center->time_from_sunday))}} To {{date("g:i a", strtotime($center->time_to_sunday))}} @else Today is close @endif <br>
