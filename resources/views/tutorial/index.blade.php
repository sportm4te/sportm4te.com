        ...
        <div class="splide__track">
            <div class="splide__list">
                <div class="splide__slide">
                    <div class="card mb-0" data-card-height="cover-full">
                        <div class="card-center text-center">
                            <h1 class="font-18 font-700 color-highlight mb-n1">Welcome to</h1>
                            <h1 class="font-40 font-800 pb-4">SportM4te</h1>
                            <h4 class="opacity-60 mb-4 pb-4">We have prepared a simple tutorial for you<br> so you can use our mobile application very easy.</h4>
                            <h1 class="text-center"><img src="https://sportm4te.com/tutorial/photos/a.svg" class="mx-auto" width="240"></h1>
                        </div>
                    </div>
                </div>
                <div class="splide__slide">
                    <div class="card mb-0" data-card-height="cover-full">
                        <div class="card-center text-center">
                            <h1 class="font-18 font-700 color-highlight mb-n1">Let's start with</h1>
                            <h1 class="font-34 font-800 pb-4">Events</h1>
                            <h4 class="opacity-60 mb-4 pb-4">In this video you see everything about events</h4>
                            <h1 class="text-center"><center><video width="250" height="220" controls class="mx-auto" preload="metadata">
                                <source src="https://sportm4te.com/tutorial/videos/events.mp4#t=0.1" type="video/mp4" class="mx-auto">
                ...
                <div class="splide__slide">
                    <div class="card mb-0" data-card-height="cover-full">
                        <div class="card-center text-center">
                            <h1 class="font-18 font-700 color-highlight mb-n1">Continue with</h1>
                            <h4 class="font-34 font-800 pb-4">Submit Score after events</h4>
                            <h4 class="opacity-60 mb-4 pb-4">In this video you will see how to add score when you finished your event</h4>
                            <h1 class="text-center"><center><video width="250" height="200" controls preload="metadata">
                                <source src="https://sportm4te.com/tutorial/videos/events.mp4#t=0.1" type="video/mp4">
                              Your browser does not support the video tag.
                              </video></center></h1>
                        </div>
                    </div>
                ...
                <div class="splide__slide">
                    <div class="card mb-0" data-card-height="cover-full">
                        <div class="card-center text-center">
                            <h1 class="font-18 font-700 color-highlight mb-n1">Last important video</h1>
                            <h1 class="font-34 font-800 pb-4">Sport Centers</h1>
                            <h4 class="opacity-60 mb-4 pb-4">In this video you will see<br> everything about Sport Centers</h4>
                            <h1 class="text-center"><center><video width="250" height="200" controls preload="metadata">
                                <source src="https://sportm4te.com/tutorial/videos/events.mp4#t=0.1" type="video/mp4">
                              Your browser does not support the video tag.
                              </video></center></h1>
                ...
                <div class="splide__slide">
                    <form action="/tutorial-add" method="post">
                    @csrf
                        <div class="card mb-0" data-card-height="cover-full">
                            <div class="card-center text-center">
                                <h1 class="font-34 font-800 pb-4">Done, you are now ready to use our app</h1>
                                <input type="text" name="tutorial" value="1" hidden>
                                <input type="text" name="name" hidden value="asdasd">
                                <h1 class="text-center"><input type="submit" value="Finish" class="btn btn-m btn-full mb-3 rounded-xl text-uppercase font-900 shadow-s bg-red-light mx-auto"></h1>
                                <h1 class="text-center"><img src="https://sportm4te.com/tutorial/photos/6.svg" class="mx-auto" width="300"></h1>
                            </div>
                        </div>
                    </form>
                </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function init_template(){
        ...
        if(inputField.length){
            ...
            var passwordFields = document.querySelectorAll('.validate-field .validate-password');
            ...
            if(validateField.length){
                validateField.forEach(el => el.addEventListener('keyup', e => {
                    ...
                    switch(getAttribute){
                        ...
                        case 'password':
                            (el.value.length >= el.minLength
                                && (passwordFields.length < 2
                                    || passwordFields[0].value == passwordFields[1].value
                                    || (passwordFields[0].isSameNode(el) && !passwordFields[1].value)
                                )
                            ) ? valid(el) : invalid(el); break;
                    }
        ...
        if(footerBar6){
            ...
            footerBar6_select && footerBar6_select.insertAdjacentHTML('beforeend', '<em></em>');
            footerBar6_circle && footerBar6_circle.insertAdjacentHTML('beforeend', '<strong><u></u></strong>');
        }
